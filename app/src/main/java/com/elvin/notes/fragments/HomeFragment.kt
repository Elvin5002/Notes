...
import com.elvin.notes.adapter.NoteAdapter
import com.elvin.notes.databinding.FragmentHomeBinding
...
class HomeFragment : Fragment(R.layout.fragment_home), SearchView.OnQueryTextListener, MenuProvider {
    ...
    override fun onCreateMenu(menu: Menu, menuInflater: MenuInflater) {
        ...
        val searchMenu = menu.findItem(R.id.serchMenu).actionView as SearchView
